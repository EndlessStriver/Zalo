...
public class MessageController {
	...
	@PostMapping("/images")
	public ResponseEntity<?> createMessageImage(@RequestParam(required = true) String chatRoomId, @RequestParam(required = true) MultipartFile file, HttpServletRequest httpServletRequest) throws Exception {
